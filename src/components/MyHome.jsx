      ...
      <Container style={{ backgroundColor: "#f3f2ef", marginTop: "20px" }}>
        <Row className="justify-content-center">
            ...
            <Card>
              ...
              <Card.Body style={{ paddingLeft: "10px", paddingRight: "10px" }}>
                ...
                <div className="text-center">
                  <Card.Title className="fs-6 mt-4 mb-4">Ti diamo il benvenuto Dario Salvatore!</Card.Title>
                </div>
                <hr className="my-2" />
                <div className="d-flex justify-content-beetwen">
                  <div>
                    <p className="text-secondary mb-0" style={{ fontSize: "small" }}>
                      Collegamenti
                    </p>
                ...
                <div>
                  ...
                  <a className=" text-dark" style={{ fontSize: "small" }} href="#">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
          ...
          <Col lg={5}>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group controlId="scrivi qualcosa">
                    <Form.Control
                      ...
                      rows={5}
                      value={addComment}
                      onChange={e => setAddComment(e.target.value)}></Form.Control>
            ...
            <Card>
              {listaPosts.slice(0, 20).map(post => (
                <div
                  key={post._id}
                  style={{
                    paddingLeft: "10px",
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <div className="d-flex">
                      <div>
                        <img className="me-2" src={post.user.image} width={48} />
                      </div>
                      <div>
                        <h6 className="mb-0">
                  ...
                  <div className="d-flex justify-content-between mt-1">
                    <div className="ms-2">
                      <a href="#" style={{ textDecoration: "none", fontSize: "small" }} className="text-secondary">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="13"
                          height="13"
