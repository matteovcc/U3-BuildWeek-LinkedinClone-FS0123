          ...
          <Col lg={9}>
            <div className="profileCard mb-3">
              <Card>
                ...
                />
                <Card.Body>
                  <img src={user.image} alt="foto-profilo" width={150} style={{ borderRadius: "50%" }} />
                  ...
                  <Card.Text>
                    ...
                    <div className="d-flex mt-2">
                      ...
                      <div>
                        ...
                        <p className="fs-6">Salva e gestisci i tuoi collegamenti e interessi.</p>
                      </div>
                    </div>
                  </Card.Text>
                  <hr />
              ...
              <Card>
                <Card.Body>
                  <Card.Title className="fs-5 mb-0 d-flex split">
                    ...
                    <div>
                      <button className="me-3" style={{ border: "none", backgroundColor: "transparent" }}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="25"
                          height="25"
                      ...
                      <button className="me-2" style={{ border: "none", backgroundColor: "transparent" }}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
                          height="20"
