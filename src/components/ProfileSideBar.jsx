        ...
        <Col xs={2} className="bg-light">
            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <div className="d-flex align-items-center">
                  <img src="https://picsum.photos/40/40" alt="" className="rounded-circle me-2" />
                  <h6 className="mb-0">Nome Profilo</h6>
                </div>
                <p className="small ms-5 mt-0">
                  Profile Summary m error ut, dolorum molestias vel saepe velituptatum. Modi, quod beatae!
                </p>
                <Button
          ...
          <Card className="mt-1 py-3 px-2">
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                ...
                <p className="small ms-5 mt-0">Profile Summary m error ut, dolorum molestias vel saepe</p>
                <Button
                  variant="transparent border-1 border-secondary rounded-5 ms-5 py-1 fw-semibold text-secondary"
                  className="btn-grey">
                  <svg
          ...
          <Card className="mt-1 py-3 px-2">
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <div className="d-flex align-items-center">
                  <img src="https://picsum.photos/40/40" alt="" className="me-2" />
                  <h6 className="mb-0">Nome Community</h6>
                </div>
                <p className="small ms-5 mt-0">Community Summary m error ut, dolorum molestias vel saepe</p>
                <div className="d-flex align-items-center ms-5">
                  <img src="https://picsum.photos/28/28" alt="" className="rounded-circle rounded-5 me-1" />
